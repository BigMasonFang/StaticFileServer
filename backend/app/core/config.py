...
# # to differ dev and prod
# config = Config(".env_dev")

# DEBUG: bool = config("DEBUG", cast=bool, default=False) or os.getenv("DEBUG", "True")
# print(DEBUG)
# TEST = os.getenv("TEST") or config("TEST", cast=str, default='test')
# print(TEST)
...
class Settings(BaseSettings):
    ...
    DATABASE_URI: Optional[
        str] = 'postgresql://postgres:postgres@localhost/postgres'
